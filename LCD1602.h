...
#define RS PB2			// ѕин команда/данные.	≈сли мы подадим на данную ножку логический 0, то значит будет команда, если 1 Ч то это данные.
...
#define E  PB0			// ѕин тактировни€		ѕо спадающему фронту (когда 1 мен€етс€ в 0) на которой контроллер диспле€ понимает, что именно сейчас наступил момент чтени€ данных на ножках данных D0 Ч D7, либо передачи данных из модул€ в зависимости также от состо€ни€ ножки RW.
